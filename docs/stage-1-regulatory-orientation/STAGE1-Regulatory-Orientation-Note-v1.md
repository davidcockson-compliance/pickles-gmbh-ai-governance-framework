...
**EU AI Act transparency obligations for providers and deployers (Article 50 — effective 2 August 2026):**

Under Article 50, transparency obligations are split between providers and deployers:
- **Provider obligations (Article 50(1)–(2)):** Providers must ensure AI systems interacting with natural persons disclose the AI nature of the interaction; providers generating synthetic content must mark outputs in machine-readable format.
- **Deployer obligations (Article 50(3)–(4)):** Deployers of emotion recognition or biometric categorisation systems must inform affected persons; deployers producing deep fakes or AI-generated text for public interest must disclose that content is AI-generated.

- Lawyers as deployers must disclose where AI-generated text is published to inform the public about matters of public interest (Article 50(4))
...
- Must inform users that they are interacting with AI where not otherwise obvious from context (Article 50(1))
- Must mark AI-generated content in machine-readable format (Article 50(2))
